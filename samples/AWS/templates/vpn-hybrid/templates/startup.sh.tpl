...
<table class="bordered">
  <tbody>
    <tr>
      <td>Name</td>
      <td><?php printf(metadata_value("hostname")) ?></td>
    </tr>
    <tr>
      <td>ID</td>
      <td><?php printf(metadata_value("ami-id")) ?></td>
    </tr>
    <tr>
      <td>Hostname</td>
      <td><?php printf(metadata_value("hostname")) ?></td>
    ...
    <tr>
      <td>Zone</td>
      <td><?php printf(metadata_value("placement/region")) ?></td>
    </tr>
    <tr>
      <td>Tags</td>
      <td><?php printf(metadata_value("tags/instance")) ?></td>
    </tr>
    <tr>
      <td>Machine Type</td>
      <td><?php printf(metadata_value("instance-type")) ?></td>
    </tr>
    <tr>
      <td>Machine Image</td>
      <td><?php printf(metadata_value("ami-manifest-path")) ?></td>
    </tr>
    <tr>
      <td>Network Internal IP</td>
      <td><?php printf(metadata_value("local-ipv4")) ?></td>
    </tr>
  </tbody>
</table>
</div>
